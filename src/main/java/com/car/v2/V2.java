...
public class V2 {
        ...
        public static void main(String[] args) {
            ...
            //우승자
            int max = maxScore(car1score, car2score, car3score);
            List<String> winners = new ArrayList<>();

            if (car1score == max) winners.add(car1Nm);
            if (car2score == max) winners.add(car2Nm);
            if (car3score == max) winners.add(car3Nm);
